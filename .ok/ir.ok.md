...
- Live serializer and bridge evidence: `src/ir/serialize.zig`, `src/ir/ghostty.zig`
- Live implementation-gap evidence: `src/ir/opentui.zig`
...
- OpenTUI bridge evidence remains out of scope for this reconciliation pass.
...
- FALSE: `src/ir/opentui.zig` is governed by this file as completed OpenTUI integration support in this reconciliation pass.
...
- FALSE: The current checked-in IR has live evidence for a shipped OpenTUI conversion bridge from this task's scoped evidence update.
