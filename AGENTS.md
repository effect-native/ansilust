...
- **Task tracking**: Use `.ok/project-management.ok.md` for task governance and selection rules, and treat `.tasks/` as the live source of active task state, blockers, and completion evidence.
